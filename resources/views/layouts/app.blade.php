...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>SerfStagram - @yield('titulo')</title>
    ...
    <body class="bg-gray-100">
        <header class="p-5 bg-white border-b shadow">
            <div class="container flex items-center justify-between mx-auto">
                ...
                <nav class="flex items-center gap-2">
                    <a
                        class="flex items-center gap-2 text-sm text-gray-600 uppercase bg-white border rounded cursor-pointer p2 font_bold"
        ...
        <footer class="mt-10 font-bold text-center text-gray-500 uppercase p5">
            serfStagram - Todos los derechos reservados {{ now()->year }}
        </footer>
        @livewireScripts
    </body>
</html>
